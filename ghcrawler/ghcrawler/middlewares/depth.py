...
modified version of `scrapy.contrib.spidermiddleware.depth.DepthMiddleware`
(Scrapy version: 0.23.0)

support customization of depth increment via request metadata
"""
